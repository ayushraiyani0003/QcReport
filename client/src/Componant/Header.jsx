      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-6 ml-auto">
          <nav className="flex gap-8">
            <Link to="/Dashboard" className="menu_btn font-semibold">
              Dashboard
            </Link>
            <Link to="/userlist" className="menu_btn font-semibold">
              User List
            </Link>
            <Link to="/settings" className="menu_btn font-semibold">
              {" "}
              {/* Changed to /settings */}
              Setting
            </Link>
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            >
              ...
              <div className="flex flex-col text-sm text-gray-800 leading-tight">
                ...
                <span className="text-xs text-black-600">{role}</span>
              </div>
