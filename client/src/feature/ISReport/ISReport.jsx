                    ...
                    <div className="grid grid-cols-2">
                        ...
                        <div className="border-r-2 border-black p-1">
                            ...
                            <div className="p-2 space-y-2">
                                <div>
                                    ...
                                    documentation duty (d-part, DmBA (special
                                    archives))
                                </div>
                                <div>
                                    <input type="checkbox" className="mr-2" />{" "}
                                ...
                                <div className="pl-4 space-y-1">
                                    ...
                                    <label>
                                        <input
                                            ...
                                            className="mr-2"
                                        />{" "}
                                        longer interruption of production
                                    </label>
                                    <br />
                                    <label>
                                        <input
                                ...
                                <div className="pl-4 space-y-1">
                                    <label>
                                        <input
                                            ...
                                            className="mr-2"
                                        />{" "}
                                        1 presentation cover sheet (self
                                        certifying supplier)
                                    </label>
                                    <br />
                                    <label>
                                ...
                                <p>
                                    You hereby confirm that the sampling
                                    corresponding to
                                </p>
                                <div className="pl-4">
                                    <label>
                        ...
                        <div className="p-1">
                            <div>
                                ...
                                <label className="block ml-5 mb-1">
                                    <input type="checkbox" /> Following sample
                                    report
                                </label>
                                <label className="block mb-1">
                                    <input type="checkbox" />
                                    <strong>
                                        Test report of other samples
                                    </strong>
                                </label>
                                <input
                                    type="text"
                            ...
                            <div className="gap-4 mb-4">
                                <div>
                                    ...
                                    <div className="grid grid-cols-2 gap-x-8 gap-y-1">
                                        ...
                                        <label>
                                            13) <input type="checkbox" /> list
                                            used compon./part record
                                        </label>
                                        <label>
                                            5) <input type="checkbox" /> Process
                            ...
                            <textarea className="border border-black w-full h-20 p-1 text-xs leading-tight resize-none">
                                Process, machine, production site, material,
                                supplier, measuring devices are not allowed to
                                be modified after release of this PPAP. All
